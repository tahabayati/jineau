      ...
      >
        ...
        <div className="relative pt-6 px-6">
          ...
          <div className="relative w-full aspect-square flex items-center justify-center">
            ...
            {/* Central product icon/image area */}
            <div className={`relative w-3/5 h-3/5 rounded-full bg-gradient-to-br from-white/20 to-white/5 backdrop-blur-sm flex items-center justify-center transition-all duration-500 ${isHovered ? "scale-110" : "scale-100"}`}>
