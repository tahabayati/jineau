      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-3 mb-6 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-mint focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded-lg" aria-label="Jineau - Go to homepage">
              ...
              <span className="text-xl font-bold gradient-text" aria-hidden="true">Jineau</span>
            </Link>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 bg-brand-secondary border border-brand-mint/30 rounded-full flex items-center justify-center text-white/60 hover:text-white hover:bg-brand-mint hover:border-brand-mint/50 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-mint"
          ...
          <nav aria-label="Shop navigation">
            ...
            <ul className="space-y-3">
              {shopLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-white/50 hover:text-white text-sm transition-colors focus-visible:outline-none focus-visible:text-brand-mint">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Audience links */}
          <nav aria-label="For You navigation">
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <nav className="flex gap-6" aria-label="Legal">
              <Link href="/privacy" className="text-sm text-white/40 hover:text-white transition-colors focus-visible:outline-none focus-visible:text-brand-mint">
                {t("privacyPolicy")}
              </Link>
              <Link href="/terms" className="text-sm text-white/40 hover:text-white transition-colors focus-visible:outline-none focus-visible:text-brand-mint">
                {t("termsOfService")}
              </Link>
              <Link href="/refunds" className="text-sm text-white/40 hover:text-white transition-colors focus-visible:outline-none focus-visible:text-brand-mint">
                {t("refundPolicy")}
              </Link>
            </nav>
          </div>
